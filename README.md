...
```
cd my-folder
git clone git@https://github.com/everinurmind/bookstore-react.git
cd bookstore-react
```
### Install
```
...
Feel free to check the [issues page](https://github.com/everinurmind/bookstore-react/issues).
